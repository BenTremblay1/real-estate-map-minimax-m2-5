...
updated = updated.replace(propertyRegex, (match, id, transactionDate, houseAge, distanceToMRT, convenienceStores, latitude, longitude, pricePerUnit) => {
  const prop = {
    id: parseInt(id),
    transactionDate: parseFloat(transactionDate),
    houseAge: parseFloat(houseAge),
    distanceToMRT: parseFloat(distanceToMRT),
    convenienceStores: parseInt(convenienceStores),
